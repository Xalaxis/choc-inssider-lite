...
$url        = 'https://metageek.link/inssider-update-url-v1-0-2/inSSIDerSetup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'inSSIDer' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
